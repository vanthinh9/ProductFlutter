          ...
          children: [
            ...
            Row(
              ...
              children:  [
                ...
                //Liên Hệ Ngay:
                Container(
                  child: IconButton(icon: Icon(Icons.facebook,size: 40,color: Color.fromARGB(255, 79, 33, 243),),
                  onPressed: () => {
                ...
                //facebook
                Container(
                  child: IconButton(icon: Icon(Icons.phone,size: 40,color: Colors.red,),
                  onPressed: () => {}),
                ),
                //phone
                Container(
                  child: IconButton(icon: Icon(Icons.email,size: 40,color: Color.fromARGB(255, 244, 54, 133),),
                  onPressed: () => {}),
                ),
                //email
              ]
            ...
            SingleChildScrollView(
              ...
              return Container(
                ...
                child: ElevatedButton(
                  style: const  ButtonStyle(
                    backgroundColor:
                      MaterialStatePropertyAll<Color>(Color.fromARGB(255, 187, 243, 33))),
                    onPressed: () {
                },
                  child: Text(e,
              ...
              decoration: BoxDecoration(
                ...
                child: Column(
                  children:[
                    ...
                    Container(height: 100, child: Image.network(e.image.toString(),width: 200)),
                    Container(height: 40, child: Text(e.category??"")),
                    /*Container(height: 30, child: */Text(e.description??""),
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    style: const  ButtonStyle(
                          backgroundColor:
                          MaterialStatePropertyAll<Color>(Color.fromARGB(255, 33, 243, 51))),
                        onPressed: () {},
                        child: Text("Số lượng")),
                  ),
                  //Số lượng
